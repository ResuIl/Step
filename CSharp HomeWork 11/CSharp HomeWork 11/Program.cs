...
class Program
{
    ...
    static void Main()
    {
        ...
        // foreach (var n in debtors.FindAll(s => s.Debt > debtors.Average(s => s.Debt)).OrderByDescending(s => s.FullName).OrderByDescending(s => s.Debt))
        //     Console.WriteLine(n);
        ...
        // foreach (var n in debtors.FindAll(s => s.FullName.Distinct().Count() >= 3).OrderBy(s => s.FullName))
        //     Console.WriteLine($"{n.FullName}, {DateTime.UtcNow.Year - n.BirthDay.Year}, {n.Debt}");
        ...
        // foreach (var n in debtors.OrderByDescending(x => x.Debt).Take(5))
        //     Console.WriteLine(n);
